					...
					<div class="row pb-4 mb-2">
						...
						<div class="row">
							...
							<div class="col-lg-3">
											...
											<a class="img-thumbnail d-block lightbox" href="../img/products/product68.jpg" data-plugin-options="{'type':'image'}">
												<img class="img-fluid" src="../../static/img/products/product68.jpg" alt="Project Image">
											</a>
										</div>
						...
						<div class="col-md-6">
							...
							<div class="size">	<h2 class="text-color-dark font-weight-normal text-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600"><strong class="font-weight-extra-bold">Multi-Parameter Analysers (Bench Top)</strong></h2></div><br/>
								...
								<h4 class="text-color-dark font-weight-normal text-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600"><strong class="font-weight-extra-bold">Model - </strong>C1000 series  </h4><br/>
							</div> 
