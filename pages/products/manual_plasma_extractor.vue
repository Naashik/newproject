					...
					<div class="row pb-4 mb-2">
						...
						<div class="row">
							...
							<div class="col-lg-3">
											...
											<a class="img-thumbnail d-block lightbox" href="../img/products/product23.jpg" data-plugin-options="{'type':'image'}">
												<img class="img-fluid" src="../../static/img/products/product23.jpg" alt="Project Image">
											</a>
										</div>
						...
						<div class="col-md-6">
							...
							<div class="size">	<h2 class="text-color-dark font-weight-normal text-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600"><strong class="font-weight-extra-bold">Manual Plasma Extractor </strong></h2></div><br/>
								<h4 class="text-color-dark font-weight-normal text-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600"><strong class="font-weight-extra-bold">Brand - </strong>HELMER </h4>
								<h4 class="text-color-dark font-weight-normal text-4 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600"><strong class="font-weight-extra-bold">Model - </strong>PE1020</h4><br/>
							</div> 
